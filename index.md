...
* *Май 2020 — по настоящее время:* 
  ...
  #### Яндекс.Практикум (студент):
    ...
    **Проектная работа #4-8 "Mesto"** - сайт, на котором пользователь может добавлять и удалять фотографии, ставить им «лайк». **[Ссылка на репозиторий](https://github.com/MelnikovAleksei/mesto)** 
